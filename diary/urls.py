...
urlpatterns = [
    ...
    path('diary-list/', views.DiarySerchListView.as_view(), name="diary_serch"),
    ...
    #path('diary-serch/', views.test_index, name="diary_serch"),
    #path('diary-serch/', views.DiarySerchListView.as_view(), name="diary_serch"),
]
